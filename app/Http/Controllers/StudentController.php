...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'studentId' => 'required|string|unique:students,student_id|max:255|regex:/^[A-Z0-9\-]+$/',
            'gender' => 'required|in:Male,Female,Prefer not to say',
            'dob' => 'required|date|before:-16 years|after:-50 years',
            'nationality' => 'required|string|min:2|max:255|regex:/^[a-zA-Z\s\-\'\. ]+$/',
            'photoUpload' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
            
            // Academic & Enrollment Information
            'course' => 'required|string|max:255',
            'advisor' => 'nullable|string|max:255|regex:/^[a-zA-Z\s\-\'\. ]+$/',
            ...
            'emergencyName' => 'required|string|min:2|max:255|regex:/^[a-zA-Z\s\-\'\. ]+$/',
            'emergencyPhone' => 'required|string|regex:/^09\d{9}$/|size:11',
        ], [
            // Custom error messages
            'firstName.required' => 'First name is required.',
            'firstName.min' => 'First name must be at least 2 characters.',
            'firstName.regex' => 'First name may only contain letters, spaces, hyphens, apostrophes, and dots.',
            'lastName.required' => 'Last name is required.',
            'lastName.min' => 'Last name must be at least 2 characters.',
            'lastName.regex' => 'Last name may only contain letters, spaces, hyphens, apostrophes, and dots.',
            'studentId.required' => 'Student ID is required.',
            'studentId.unique' => 'This student ID is already taken.',
            'studentId.regex' => 'Student ID may only contain letters, numbers, and hyphens.',
            'dob.required' => 'Date of birth is required.',
            'dob.before' => 'Student must be at least 16 years old.',
            'dob.after' => 'Please enter a valid date of birth.',
            'nationality.required' => 'Nationality is required.',
            'nationality.regex' => 'Nationality may only contain letters, spaces, hyphens, apostrophes, and dots.',
            ...
            'phone.regex' => 'Phone number must be a valid Philippine number (09XXXXXXXXX or +639XXXXXXXXX).',
            ...
            'emergencyName.regex' => 'Emergency contact name may only contain letters, spaces, hyphens, apostrophes, and dots.',
            'emergencyPhone.required' => 'Emergency contact phone is required.',
            'emergencyPhone.regex' => 'Emergency contact phone must be a valid Philippine number (09XXXXXXXXX or +639XXXXXXXXX).',
    ...
    public function update(Request $request, Student $student)
    {
        $validatedData = $request->validate([
            ...
            'nationality.regex' => 'Nationality may only contain letters, spaces, hyphens, apostrophes, and dots.',
            'course.required' => 'Course/Department is required.',
            'advisor.regex' => 'Academic advisor name may only contain letters, spaces, hyphens, apostrophes, and dots.',
            'yearLevel.required' => 'Year level is required.',
            'academicStatus.required' => 'Academic status is required.',
            'startDate.required' => 'Start date is required.',
            'startDate.before_or_equal' => 'Start date cannot be in the future.',
